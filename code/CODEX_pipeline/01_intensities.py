...
### variables needed
INPUT_PATH="/beegfs/data/SchneiderLab/CODEX_processing/data/run46_Bella/image_cropped/"
SEG_PATH="/beegfs/data/SchneiderLab/CODEX_processing/data/run46_Bella/cell_mask_cropped/"
## second segmentation mask
SEG2_PATH='/beegfs/data/SchneiderLab/CODEX_processing/data/run46_Bella/MK_mask_cropped/'
...
seg_files_suffix='_cropped_mask'
seg2_files_suffix='_cropped_mask'
img_files_suffix=''

seg_files_suffix_replace=''
seg2_files_suffix_replace=''
img_files_suffix_replace=''
##
